...
- [5. Django_Rest_Framework](#5-django_rest_framework)
- [6. 环境安装与配置](#6-环境安装与配置)
...
- [8. 序列化器-Serializer](#8-序列化器-serializer)
  ...
  - [8.3 序列化器的使用](#83-序列化器的使用)
    - [8.3.1 序列化](#831-序列化)
    - [8.3.2  反序列化](#832--反序列化)
    - [8.3.3、基于APIView的接口实现](#833-基于apiview的接口实现)
  - [8.4 模型类序列化器](#84-模型类序列化器)
- [9. 视图](#9-视图)
  - [9.1、GenericAPIView[通用视图类]](#91-genericapiview通用视图类)
  - [9.2、5个视图扩展类](#92-5个视图扩展类)
  - [9.3、 GenericAPIView的视图子类](#93--genericapiview的视图子类)
  - [9.4、视图集](#94-视图集)
    - [9.4.1、ViewSet](#941-viewset)
    - [9.4.2、GenericViewSet](#942-genericviewset)
    - [9.4.3、ModelViewSet和ReadOnlyModelViewSet](#943-modelviewset和readonlymodelviewset)
